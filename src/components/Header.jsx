        ...
        <div className="relative w-full sm:h-auto bg-[#F1F3F4] flex items-center">
            <div className="flex flex-wrap justify-center gap-4 lg:gap-20 w-full p-4">
                ...
                <div className="flex flex-col items-center w-[120px] sm:w-[140px] md:w-[160px]">
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-gray-700 font-medium mt-2">Quiz</p>
                </div>
                <div className="flex flex-col items-center w-[120px] sm:w-[140px] md:w-[160px]">
                    <button
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-gray-700 font-medium mt-2">Survey</p>
                </div>
                <div className="flex flex-col items-center w-[120px] sm:w-[140px] md:w-[160px]">
                    <button
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-gray-700 font-medium mt-2">Feedback</p>
                </div>
                <div className="flex flex-col items-center w-[120px] sm:w-[140px] md:w-[160px]">
                    <button
                        onClick={() => handleTemplateClick('analytics')}
                        className="w-full bg-white rounded-md shadow-md hover:shadow-lg transform hover:scale-105 transition-transform duration-200"
                    >
                        <img src={img4} alt="RSVP form" className="w-full h-[80px] sm:h-[100px] object-cover rounded-t-md" />
                    </button>
                    <p className="text-xs sm:text-sm md:text-base text-gray-700 font-medium mt-2">Analytics</p>
                </div>
                <div className="flex flex-col items-center w-[120px] sm:w-[140px] md:w-[160px]">
                    <button
                    ...
                    <p className="text-xs sm:text-sm md:text-base text-gray-700 font-medium mt-2">Invitation</p>
                </div>
                <div className="flex flex-col items-center w-[120px] sm:w-[140px] md:w-[160px]">
                    <button
                        onClick={() => handleTemplateClick('party')}
                        className="w-full bg-white rounded-md shadow-md hover:shadow-lg transform hover:scale-105 transition-transform duration-200"
                    >
                        <img src={img4} alt="RSVP form" className="w-full h-[80px] sm:h-[100px] object-cover rounded-t-md" />
                    </button>
                    <p className="text-xs sm:text-sm md:text-base text-gray-700 font-medium mt-2">Party</p>
                </div>
